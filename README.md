...
|  ![Joystick Casing Open](assets/images/joystick_open.jpg "Joystick Encasing Open") | ![Videogame Gameplay](assets/images/gameplay_sc.png "Gameplay") |
| ![2nd Gameplay Screenshot](assets/images/gameplay2_sc.png "2nd Gameplay Image") | ![Game Over Screen](assets/images/game_over.png "Game Over Splash Screen") |
...
While not necessary, the joystick and FPGA board can be put into a 3D-Printed Case to make it easier for the user to handle and use. Here are some examples to use:

https://grabcad.com/library/case-for-basys-3-fpga-board-1
...
![Block Diagram for Capstone Project](assets/images/Updated_Block_Diagram.drawio.svg "Block Diagram")
...
[8] https://grabcad.com/library/case-for-basys-3-fpga-board-1 (Case for Basys 3)

[9] https://digilent.com/shop/pmod-jstk2-two-axis-joystick/ (Case for Joystick)
