...
###movement
set_property PACKAGE_PIN W19 	 [get_ports {move[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {move[0]}]	
set_property PACKAGE_PIN T17 	 [get_ports {move[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {move[1]}]		
set_property PACKAGE_PIN T18 	 [get_ports {move[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {move[2]}]			
set_property PACKAGE_PIN U17 	 [get_ports {move[3]}]
